...
const routes: Routes = [
  ...
  { path: 'missions/:id/edit', canActivate: [AuthGuardService], component: MissionEditComponent },
  ...
  { path: 'users/:id/edit', canActivate: [AuthGuardService], component: UserEditComponent },
